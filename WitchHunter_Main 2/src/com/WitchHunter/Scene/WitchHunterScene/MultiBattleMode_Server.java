...
public class MultiBattleMode_Server extends Scene {
    ...
    public void keyPressed(int commandCode, long trigTime) {
        ...
        if (commandCode == Global.D) {
            ...
            arr.add("D");
            Client.getInstance().sendCommand(new Client.Command(PLAYER2, Global.Commands.MOVE,SERVERIP, arr));
        }
    ...
    public void updateFrame(GameObject o, int id) {
        ...
        Client.getInstance().sendCommand(new Client.Command(id, Global.Commands.UPDATE_FRAME,SERVERIP,arr));
    }
    ...
    public void updateTime(int id){
        ...
        Client.getInstance().sendCommand(new Client.Command(id ,Global.Commands.TIME,SERVERIP,arr));
...
//    }
    ...
    public void updatePlayerHP(GameObject o, int id){
        ...
        Client.getInstance().sendCommand(new Client.Command(id,Global.Commands.HP,SERVERIP,arr));
    }

    public void upfatePlayerKillAmount(int id){
        ArrayList<String> arr = new ArrayList<String>();
        arr.add(Integer.toString(killAmount));
        Client.getInstance().sendCommand(new Client.Command(id,Global.Commands.KILLAMOUNT,SERVERIP,arr));
